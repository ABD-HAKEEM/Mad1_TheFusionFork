...
import 'package:the_fution_fork_mad/views/Screens/CartPage.dart' show Cart;
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: orientation == Orientation.portrait
                      ? [
                          _buildProductCard(
                              context, 'assets/images/Shushi1.jpeg', 'Sushi'),
                          _buildProductCard(
                              context, 'assets/images/burger.jpg', 'Burger'),
                        ]
                      : [
                          _buildProductCard(
                              context, 'assets/images/burger.jpg', 'Burger'),
                          _buildProductCard(
                              context, 'assets/images/Shushi1.jpeg', 'Sushi'),
                          _buildProductCard(
                              context, 'assets/images/sushi.jpg', 'Sushi 2'),
                          _buildProductCard(
                              context, 'assets/images/pizza.jpg', 'Pizza'),
                        ],
                ),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8),
                              Text('Delicious', style: TextStyle(fontSize: 14)),
                            ],
                          ),
                        ),
                        Padding(
